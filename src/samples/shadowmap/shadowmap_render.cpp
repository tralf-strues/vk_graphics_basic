...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("tonemap", {VK_GRAPHICS_BASIC_ROOT"/resources/shaders/tonemap.vert.spv", VK_GRAPHICS_BASIC_ROOT"/resources/shaders/tonemap.frag.spv"});
}
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  //
  {
    ...
    vkCmdPushConstants(a_cmdBuff, m_tonemapPipeline.getVkPipelineLayout(), VK_SHADER_STAGE_FRAGMENT_BIT, 0, sizeof(tonemapping), &tonemapping);
